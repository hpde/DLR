[![SPASE Monthly Validation](https://github.com/hpde/DLR/actions/workflows/validate-schedule.yml/badge.svg)](https://github.com/hpde/DLR/actions/workflows/validate-schedule.yml)
...
SPASE resource descriptions with the DLR naming authority.
